...
TEST (ut_xpjsonW, benchmark_write)
{
	try {
		JSON::ObjectW media;
		media.insert (make_pair (JSON_MOVE (wstring (L"uri")), JSON_MOVE (JSON::ValueW (JSON_MOVE (wstring (L"http://javaone.com/keynote.mpg"))))));
		media.insert (make_pair (JSON_MOVE (wstring (L"title")), JSON_MOVE (JSON::ValueW (JSON_MOVE (wstring (L"Javaone Keynote"))))));
		media.insert (make_pair (JSON_MOVE (wstring (L"width")), JSON_MOVE (JSON::ValueW (640))));
		media.insert (make_pair (JSON_MOVE (wstring (L"height")), JSON_MOVE (JSON::ValueW (480))));
		media.insert (make_pair (JSON_MOVE (wstring (L"format")), JSON_MOVE (JSON::ValueW (JSON_MOVE (wstring (L"video/mpg4"))))));
		media.insert (make_pair (JSON_MOVE (wstring (L"duration")), JSON_MOVE (JSON::ValueW (1800000))));
		media.insert (make_pair (JSON_MOVE (wstring (L"size")), JSON_MOVE (JSON::ValueW (58982400))));
		media.insert (make_pair (JSON_MOVE (wstring (L"bitrate")), JSON_MOVE (JSON::ValueW (262144))));

		JSON::ArrayW persons;
		persons.push_back (JSON_MOVE (JSON::ValueW (JSON_MOVE (wstring (L"Bill Gates")))));
		persons.push_back (JSON_MOVE (JSON::ValueW (JSON_MOVE (wstring (L"Steve Jobs")))));
		media.insert (make_pair (JSON_MOVE (wstring (L"persons")), JSON_MOVE (persons)));

		media.insert (make_pair (JSON_MOVE (wstring (L"player")), JSON_MOVE (JSON::ValueW (JSON_MOVE (wstring (L"JAVA"))))));
		media.insert (make_pair (JSON_MOVE (wstring (L"copyright")), JSON_MOVE (JSON::ValueW ())));
		...
		image1.insert (make_pair (JSON_MOVE (wstring (L"uri")), JSON_MOVE (JSON::ValueW (JSON_MOVE (wstring (L"http://javaone.com/keynote_large.jpg"))))));
		image1.insert (make_pair (JSON_MOVE (wstring (L"title")), JSON_MOVE (JSON::ValueW (JSON_MOVE (wstring (L"Javaone Keynote"))))));
		image1.insert (make_pair (JSON_MOVE (wstring (L"width")), JSON_MOVE (JSON::ValueW (1024))));
		image1.insert (make_pair (JSON_MOVE (wstring (L"height")), JSON_MOVE (JSON::ValueW (768))));
		image1.insert (make_pair (JSON_MOVE (wstring (L"size")), JSON_MOVE (JSON::ValueW (JSON_MOVE (wstring (L"LARGE"))))));

		JSON::ObjectW& image2 = images[1].o ();
		image2.insert (make_pair (JSON_MOVE (wstring (L"uri")), JSON_MOVE (JSON::ValueW (JSON_MOVE (wstring (L"http://javaone.com/keynote_small.jpg"))))));
		image2.insert (make_pair (JSON_MOVE (wstring (L"title")), JSON_MOVE (JSON::ValueW (JSON_MOVE (wstring (L"Javaone Keynote"))))));
		image2.insert (make_pair (JSON_MOVE (wstring (L"width")), JSON_MOVE (JSON::ValueW (320))));
		image2.insert (make_pair (JSON_MOVE (wstring (L"height")), JSON_MOVE (JSON::ValueW (240))));
		image2.insert (make_pair (JSON_MOVE (wstring (L"size")), JSON_MOVE (JSON::ValueW (JSON_MOVE (wstring (L"SMALL"))))));

		JSON::ObjectW o;
		o.insert (make_pair (JSON_MOVE (wstring (L"media")), JSON_MOVE (media)));
		o.insert (make_pair (JSON_MOVE (wstring (L"images")), JSON_MOVE (images)));
