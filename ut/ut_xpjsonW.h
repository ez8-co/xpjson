...
TEST(ut_xpjsonW, benchmark_write)
{
	try {
		JSON::ValueW v;

		JSON::ObjectW& media = v[L"media"].o();
		media.insert(make_pair(JSON_MOVE(JSON_TSTRING(wchar_t)(L"uri")), JSON_MOVE(JSON::ValueW(JSON_MOVE(JSON_TSTRING(wchar_t)(L"http://javaone.com/keynote.mpg")), false))));
		media.insert(make_pair(JSON_MOVE(JSON_TSTRING(wchar_t)(L"title")), JSON_MOVE(JSON::ValueW(JSON_MOVE(JSON_TSTRING(wchar_t)(L"Javaone Keynote")), false))));
		media.insert(make_pair(JSON_MOVE(JSON_TSTRING(wchar_t)(L"width")), JSON_MOVE(JSON::ValueW(640))));
		media.insert(make_pair(JSON_MOVE(JSON_TSTRING(wchar_t)(L"height")), JSON_MOVE(JSON::ValueW(480))));
		media.insert(make_pair(JSON_MOVE(JSON_TSTRING(wchar_t)(L"format")), JSON_MOVE(JSON::ValueW(JSON_MOVE(JSON_TSTRING(wchar_t)(L"video/mpg4")), false))));
		media.insert(make_pair(JSON_MOVE(JSON_TSTRING(wchar_t)(L"duration")), JSON_MOVE(JSON::ValueW(1800000))));
		media.insert(make_pair(JSON_MOVE(JSON_TSTRING(wchar_t)(L"size")), JSON_MOVE(JSON::ValueW(58982400))));
		media.insert(make_pair(JSON_MOVE(JSON_TSTRING(wchar_t)(L"bitrate")), JSON_MOVE(JSON::ValueW(262144))));

		JSON::ArrayW& persons = media[L"persons"].a();
		persons.push_back(JSON_MOVE(JSON::ValueW(JSON_MOVE(JSON_TSTRING(wchar_t)(L"Bill Gates")), false)));
		persons.push_back(JSON_MOVE(JSON::ValueW(JSON_MOVE(JSON_TSTRING(wchar_t)(L"Steve Jobs")), false)));

		media[L"player"] = JSON_MOVE(JSON::ValueW(JSON_MOVE(JSON_TSTRING(wchar_t)(L"JAVA")), false));
		media[L"copyright"];

		JSON::ArrayW& images = v[L"images"].a();
		images.push_back(JSON_MOVE(JSON::ValueW(JSON_MOVE(JSON::ObjectW()))));
		images.push_back(JSON_MOVE(JSON::ValueW(JSON_MOVE(JSON::ObjectW()))));

		JSON::ObjectW& image1 = images[0].o();
		image1.insert(make_pair(JSON_MOVE(JSON_TSTRING(wchar_t)(L"uri")), JSON_MOVE(JSON::ValueW(JSON_MOVE(JSON_TSTRING(wchar_t)(L"http://javaone.com/keynote_large.jpg")), false))));
		image1.insert(make_pair(JSON_MOVE(JSON_TSTRING(wchar_t)(L"title")), JSON_MOVE(JSON::ValueW(JSON_MOVE(JSON_TSTRING(wchar_t)(L"Javaone Keynote")), false))));
		image1.insert(make_pair(JSON_MOVE(JSON_TSTRING(wchar_t)(L"width")), JSON_MOVE(JSON::ValueW(1024))));
		image1.insert(make_pair(JSON_MOVE(JSON_TSTRING(wchar_t)(L"height")), JSON_MOVE(JSON::ValueW(768))));
		image1.insert(make_pair(JSON_MOVE(JSON_TSTRING(wchar_t)(L"size")), JSON_MOVE(JSON::ValueW(JSON_MOVE(JSON_TSTRING(wchar_t)(L"LARGE"))))));

		JSON::ObjectW& image2 = images[1].o();
		image2.insert(make_pair(JSON_MOVE(JSON_TSTRING(wchar_t)(L"uri")), JSON_MOVE(JSON::ValueW(JSON_MOVE(JSON_TSTRING(wchar_t)(L"http://javaone.com/keynote_small.jpg")), false))));
		image2.insert(make_pair(JSON_MOVE(JSON_TSTRING(wchar_t)(L"title")), JSON_MOVE(JSON::ValueW(JSON_MOVE(JSON_TSTRING(wchar_t)(L"Javaone Keynote")), false))));
		image2.insert(make_pair(JSON_MOVE(JSON_TSTRING(wchar_t)(L"width")), JSON_MOVE(JSON::ValueW(320))));
		image2.insert(make_pair(JSON_MOVE(JSON_TSTRING(wchar_t)(L"height")), JSON_MOVE(JSON::ValueW(240))));
		image2.insert(make_pair(JSON_MOVE(JSON_TSTRING(wchar_t)(L"size")), JSON_MOVE(JSON::ValueW(JSON_MOVE(JSON_TSTRING(wchar_t)(L"SMALL")), false))));
...
TEST(ut_xpjsonW, benchmark_read)
{
	try {
		wstring in(L"{\"images\":[{\"height\":768,\"size\":\"LARGE\",\"title\":\"Javaone Keynote\",\"uri\":\"http:\\/\\/javaone.com\\/keynote_large.jpg\",\"width\":1024},{\"height\":240,\"size\":\"SMALL\",\"title\":\"Javaone Keynote\",\"uri\":\"http:\\/\\/javaone.com\\/keynote_small.jpg\",\"width\":320}],\"media\":{\"bitrate\":262144,\"copyright\":null,\"duration\":1800000,\"format\":\"video\\/mpg4\",\"height\":480,\"persons\":[\"Bill Gates\",\"Steve Jobs\"],\"player\":\"JAVA\",\"size\":58982400,\"title\":\"Javaone Keynote\",\"uri\":\"http:\\/\\/javaone.com\\/keynote.mpg\",\"width\":640}}");
		JSON::ValueW v;
		JSON::ReaderW::read(v, in.c_str(), in.length());
	}
	catch(std::exception &e) {
